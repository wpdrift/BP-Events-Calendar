...
<div class="buddypress-events-calendar-details eventForm bubble" id="event_tribe_venue">
    ...
    <table class="tribe-community-event-info" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td colspan="2" class="tribe_sectionheader">
                <h4><label class=""><?php
                        printf( __( '%s Details', 'bp-events-calendar' ), $venue_label_singular );
                        //	echo bpec_field_marker( 'venue' );
                        ?></label></h4>
            </td><!-- .tribe_sectionheader -->
        </tr>

        <?php  do_action( 'tribe_venue_table_top', $event_form->event_id ); ?>

        <?php if ( ! bpec_is_venue_edit_screen() ) { ?>
            <tr class="venue linked-post">
                <td>
                    <label for="VenueVenue" <?php if ( $event && $_POST && empty( $venue_name ) ) echo 'class="error"'; ?>>
                        <?php printf( __( '%s Name', 'bp-events-calendar' ), $venue_label_singular ); ?>:
                    </label>
                </td>
                <td>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="VenueAddress">
                    <?php esc_html_e( 'Address', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="VenueCity">
                    <?php esc_html_e( 'City', 'bp-events-calendar' ); ?>:
                </label>
            </td>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="EventCountry">
                    <?php esc_html_e( 'Country', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
        ...
        <tr class="venue linked-post">
            ...
            <td>
                <label for="StateProvinceText">
                    <?php esc_html_e( 'State or Province', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
                ...
                <select class="chosen" id="StateProvinceSelect" name="venue[State]">
                    <option value=""><?php esc_html_e( 'Select a State', 'bp-events-calendar' ); ?></option>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="EventZip">
                    <?php esc_html_e( 'Postal Code', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="EventPhone">
                    <?php esc_html_e( 'Phone', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
        ...
        <tr class="venue linked-post">
            <td>
                <label for="EventWebsite">
                    <?php esc_html_e( 'Website', 'bp-events-calendar' ); ?>:
                </label>
            </td>
            <td>
                ...
                <tr id="google_map_toggle" class="remain-visible">
                    <td>
                        <label for="EventShowMap">
                            <?php esc_html_e( 'Show Google Map', 'bp-events-calendar' ); ?>:
                        </label>
                    </td>
                    <td>
            ...
            <tr id="google_map_link_toggle" class="remain-visible">
                <td>
                    <label for="EventShowMapLink">
                        <?php esc_html_e( 'Show Google Maps Link', 'bp-events-calendar' ); ?>:
                    </label>
                </td>
                <td>
